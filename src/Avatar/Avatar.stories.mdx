...
As usual, 13 sizes are available.

<Preview>
  <Story name="sizes">
    <Inline>
      <Avatar size="9xl" title="MD" onPress={action('pressed')} />
      <Avatar size="8xl" title="MD" onPress={action('pressed')} />
      <Avatar size="7xl" title="MD" onPress={action('pressed')} />
      <Avatar size="6xl" title="MD" onPress={action('pressed')} />
